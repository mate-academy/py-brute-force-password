...
def brute_force_password(start, stop, hash_list) -> None:
    for i in range(start, stop + 1):
        format_numb = "{:08d}".format(i)
        if sha256_hash_str(format_numb) in hash_list:
            print(format_numb)


def speed_up_brute_force():
    processes = []
