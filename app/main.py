...
def process_range(start: int, end: int, target_hashes: set) -> dict:
    """Process a range of numbers to find matching password hashes."""
    found = {}
...
def brute_force_password() -> None:
    """
    Brute force passwords using parallel processing.

    Splits the work across available CPU cores using ProcessPoolExecutor.
    Tries all 8-digit numeric passwords to find matches
    for the target hashes defined in PASSWORDS_TO_BRUTE_FORCE.

    Prints each found hash and its corresponding password.
    """
