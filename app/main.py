...
def brute_force_password(password_range) -> None:
...
def bruto_force_pool_executor():
    num_processes = multiprocessing.cpu_count() - 1
    passwords_per_process = 100000000 // num_processes

    ranges = [(i * passwords_per_process, (i + 1) * passwords_per_process) for i in range(num_processes)]
    if passwords_per_process * num_processes < 100000000:
        ranges.append((passwords_per_process * num_processes, 100000000))
